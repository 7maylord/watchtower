...
var eventSignature = "ComplianceScreeningRequested(address,uint256)";
var onLogTrigger = async (runtime2, log) => {
  ...
  runtime2.log(`ComplianceScreeningRequested by ${decodedLog.args.requester} at ${decodedLog.args.timestamp}`);
